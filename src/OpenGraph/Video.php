...
class Video {
     ...
     * @return string
     */
    public static function Video(?string $url = null) : string {
     ...
     * @return string
     */
    public static function SecureUrl(?string $url = null) : string {
     ...
     * @return string
     */
    public static function Height(?int $height = 1) : string {
     ...
     * @return string
     */
    public static function Width(?int $width = 1) : string {
     ...
     * @return string
     */
    public static function Duration(?int $duration = 1) : string {
     ...
     * @return string
     */
    public static function Actor(?string $actor = null) : string {
     ...
     * @return string
     */
    public static function ActorRole(?string $role = null) : string {
     ...
     * @return string
     */
    public static function Director(?string $director = null) : string {
     ...
     * @return string
     */
    public static function Writer(?string $writer = null) : string {
     ...
     * @return string
     */
    public static function Series(?string $title = null) : string {
